        ...
        if (front == "" || back == "") {
            ...
            try {
                const { data, error } = await supabase.from("cards").insert({
                    ...
                    front: front,
                    back: back,
                    special_type: type == "latex" ? type : null,
                });
            ...
            {user && (
                ...
                >
                    ...
                    <Textarea
                        ...
                        size="md"
                        radius="xs"
                        placeholder={type == "latex" ? "Enter Text With $LaTeX$" : "Enter Text Here"}
                        autosize
                        minRows={4}
                        pb={"8px"}
                    />
                    {type == "latex" && <SmartLatex content={front} />}
                    <Text fw={700} size="lg" pb={"10px"} pt={"10px"}>
                        Back
                    </Text>
                    <Textarea
                        ...
                        pb={"8px"}
                    />
                    {type == "latex" && <SmartLatex content={back} />}
                </Box>
            )}
        </Box>
    );
